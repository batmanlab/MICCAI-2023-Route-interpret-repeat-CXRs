...
from Explainer.experiments_explainer_mimic_cxr import train_glt
...
parser.add_argument('--start_seed', default=0, type=int, metavar='N', help='seed')
...
parser.add_argument('--lr-residual', '--learning-rate-residual', default=0.01, type=float,
...
parser.add_argument('--weight-decay-residual', type=float, default=0.0001, help='weight_decay for SGD')
...
parser.add_argument('--epochs-residual', type=int, default=1, help='batch size for training the residual')
...
def main():
    ...
    print("Training explainer for MIMIC-CXR")
    train_glt(args)
